  ...
  return (
    <div className="min-h-screen bg-slate-50 p-8 flex flex-col items-center font-sans">
      <div className="w-full max-w-2xl">
        <h1 className="text-3xl font-extrabold text-slate-800 mb-8">Untitled Link Manager (Under maintenance)</h1>
        <div className="bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden">
          <div className="px-6 py-4 border-b border-slate-100 bg-slate-50/50">
            <h2 className="text-sm font-bold text-slate-500 uppercase">Sites (May not work correctly for the time being)</h2>
          </div>
